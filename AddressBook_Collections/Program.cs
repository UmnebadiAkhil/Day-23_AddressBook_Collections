...
namespace Day_13_AddressBook
{
    class Program
    {
        ...
        {
            //Contact is used to access contact details 
        ...
        public static void edit_data(List<Contact> Contact)
        {
            ...
            while (choice != 5)
            {
                ...
                //first obj gets added into list in every iteration of while loop, stores into Contact list, then modifies content in case 2,3 through Contact list
